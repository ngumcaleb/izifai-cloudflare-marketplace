    ...
    <div class="flex-1 flex flex-col min-h-dvh lg:min-h-screen bg-surface-container-lowest">
        ...
        <div class="lg:hidden relative overflow-hidden bg-gradient-to-br from-[#00210d] via-[#003317] to-[#005228] px-6 pt-5 pb-8">
            ...
            <div class="relative z-10 flex items-center gap-3">
                ...
                <div>
                    <p class="text-sm font-bold text-white">No Worries — We Will Help</p>
                    <p class="text-xs text-white/70">Enter your email and we will send you a secure link to reset your password.</p>
                </div>
            </div>
        </div>
        ...
        <div class="flex-1 flex items-center justify-center px-5 py-6 lg:py-0">
            <div class="w-full max-w-md">
                ...
                <div class="hidden lg:block mb-8">
                    ...
                    <p class="text-sm text-on-surface-variant mt-1">Enter your email and we will send you a secure reset link.</p>
                </div>
