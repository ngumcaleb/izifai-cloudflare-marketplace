            ...
            <div class="space-y-3">
                <div class="flex items-start gap-4 p-4 rounded-xl bg-white/10 backdrop-blur-sm border border-white/10">
                    <div class="w-10 h-10 rounded-lg bg-primary-container flex items-center justify-center shrink-0">
                        <i class="fa-solid fa-book-open text-on-primary-container text-[22px]" style=""></i>
                    </div>
                    <div>
                ...
                <div class="flex items-start gap-4 p-4 rounded-xl bg-white/10 backdrop-blur-sm border border-white/10">
                    <div class="w-10 h-10 rounded-lg bg-primary-container flex items-center justify-center shrink-0">
                        <i class="fa-solid fa-share-nodes text-on-primary-container text-[22px]" style=""></i>
                    </div>
                    <div>
                ...
                <div class="flex items-start gap-4 p-4 rounded-xl bg-white/10 backdrop-blur-sm border border-white/10">
                    <div class="w-10 h-10 rounded-lg bg-primary-container flex items-center justify-center shrink-0">
                        <i class="fa-solid fa-arrow-trend-up text-on-primary-container text-[22px]" style=""></i>
                    </div>
                    <div>
