<x-seller-layout>
    ...
    <div class="max-w-2xl mx-auto animate-fade-in">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 md:mb-6">
            <div>
                <h1 class="text-xl md:text-2xl font-bold text-gray-900">Edit Category</h1>
        ...
        <form action="{{ route('seller.store-categories.update', $category->id) }}" method="POST" class="space-y-4 md:space-y-6">
            @csrf @method('PUT')
            ...
            <div class="bg-white rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100/80 space-y-4">
                ...
                <div class="space-y-1.5">
                    ...
                    <p class="text-xs text-gray-400 ml-1">Leave empty for a top-level category.</p>
                </div>
            </div>
