<x-seller-layout>
    <x-slot name="title">Post New Service</x-slot>

    <div class="max-w-4xl mx-auto animate-fade-in">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-4 md:mb-6">
            <div>
                <h1 class="text-xl md:text-2xl font-bold text-gray-900">Add Service</h1>
        ...
        <form action="{{ route('seller.services.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4 md:space-y-6"
              x-data="{
                scActive: false,
                scCustom: false,
                scVal: '',
                packages: [],
                addPackage() {
                    this.packages.push({ name: '', description: '', price: '', delivery_time: '' });
                },
                removePackage(i) {
            ...
            <div class="bg-white rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100/80 space-y-4 md:space-y-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                    <div class="md:col-span-2 space-y-1.5">
                        ...
                        <input type="text" name="name" required placeholder="e.g. Professional Photography Session"
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="number" name="starting_price" required placeholder="e.g. 50000"
                               class="w-full h-11 md:h-12 bg-gray-50 border border-gray-200 rounded-xl px-4 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/50">
                    </div>
                    <div class="space-y-1.5">
                        <label class="text-xs font-semibold text-gray-500 ml-1">Delivery Time</label>
                        <input type="text" name="delivery_time" placeholder="e.g. 3 days, 1 week"
                               class="w-full h-11 md:h-12 bg-gray-50 border border-gray-200 rounded-xl px-4 text-sm focus:outline-none focus:ring-2 focus:ring-primary/30 focus:border-primary/50">
                    </div>
                    <div class="space-y-1.5">
            ...
            <div class="bg-white rounded-2xl p-4 md:p-6 shadow-sm border border-gray-100/80 space-y-4 md:space-y-5">
                <div class="space-y-4">
                    ...
                    <textarea name="description" rows="5" required placeholder="Describe your service, what's included, delivery process..."
